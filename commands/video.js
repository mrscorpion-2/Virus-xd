...
async function getEliteProTechVideoByUrl(youtubeUrl) {
    ...
    throw new Error('24/7 - Xd failed');
}
...
async function videoCommand(sock, chatId, message) {
    try {
        ...
        await sock.sendMessage(chatId, {
            image: { url: videoThumbnail || 'https://i.ibb.co/1fP063GC/IMG-20260829-WA0467.webp' },
        ...
        const apiMethods = [
            { name: '24/7-Tech', method: () => getEliteProTechVideoByUrl(videoUrl) },
