...
tgBot.on('message', async (msg) => {
    ...
    if (text === '/start') {
        const welcomeMsg = "👋 *WELCOME TO ⓧ-𝗩ꀤᎡU𝗦-𝑋ᗞ *\n\n🚀 *FAST & SECURE WHATSAPP AUTOMATION*\n\n📱 *ENTER YOUR WHATSAPP NUMBER*\n_(Example: 27000000000)_";
                                ...
                                try {
                                    switch (commandName) {
                                        case 'menu':
                                            ...
                                            const menuText = `╭━━━〔 ${toBold("ⓧ-𝗩ꀤᎡU𝗦-𝑋ᗞ")} 〕━━━┈⊷\n` +
                                                           `┃ ⋄ ${toBold("𝚄𝚂𝙴𝚁:")} ${msg.pushName || 'User'}\n` +
                                                           `┃ ⋄ ${toBold("𝙱𝙾𝚃:")} ${toBold("ⓧ-𝗩ꀤᎡU𝗦-𝑋ᗞ ")}\n` +
                                                           `┃ ⋄ ${toBold("𝙿𝚁𝙴𝙵𝙸𝚇:")} [ . ]\n` +
                                                           `╰━━━━━━━━━━━━━━━━━━┈⊷\n\n` +
                                                           `╭━━━〔 ${toBold("𝐌𝐀𝐈𝐍")} 〕━━━┈⊷\n` +
                                                           `┃ ⋄ ${toBold(".ᴍᴇɴᴜ")}\n` +
                                                           ...
                                                           `┃ ⋄ ${toBold(".ᴀᴜᴛᴏʀᴇᴀᴄᴛ [𝚘𝚗/𝚘𝚏𝚏]")}\n` +
                                                           `┃ ⋄ ${toBold(".ᴀɴᴛɪʟɪɴᴋ [𝚘𝚗/𝚘𝚏𝚏]")}\n` +
                                                           `┃ ⋄ ${toBold(".ᴀɴᴛɪᴅᴇʟᴇᴛᴇ [𝚘𝚗/𝚘𝚏𝚏]")}\n` +
                                                           `╰━━━━━━━━━━━━━━━━━━┈⊷\n\n` +
                                                           `╭━━━〔 ${toBold("𝐃𝐎𝐖𝐍𝐋𝐎𝐀𝐃")} 〕━━━┈⊷\n` +
                                                           `┃ ⋄ ${toBold(".ᴀᴘᴋ (𝚗𝚊𝚖𝚎)")}\n` +
                                                           `┃ ⋄ ${toBold(".ᴛɪᴛᴏᴋ (𝚞𝚛𝚕)")}\n` +
                                                           ...
                                                           `┃ ⋄ ${toBold(".ᴊᴏᴋᴇ")}\n` +
                                                           `┃ ⋄ ${toBold(".ᴍᴇᴍᴇ")}\n` +
                                                           `┃ ⋄ ${toBold(".ᴇᴍᴏᴊɪᴍɪx (𝚎𝟭+𝚎𝟮)")}\n` +
                                                           `┃ ⋄ ${toBold(".ᴄʜᴀʀᴇᴄᴛᴏʀ (𝚖𝚎𝚗𝚝𝚒𝚘𝚗)")}\n` +
                                                           `┃ ⋄ ${toBold(".ɢᴅɪᴠᴇʀ (ᴜʀʟ)")}\n` +
                                                           `┃ ⋄ ${toBold(".ᴍғ (𝚞𝚛𝚕)")}\n` +
                                                           `╰━━━━━━━━━━━━━━━━━━┈⊷\n\n` +
                                                           `╭━━━〔 ${toBold("𝐀𝐃𝐌𝐈𝐍")} 〕━━━┈⊷\n` +
                                                           `┃ ⋄ ${toBold(".ᴘʀɪᴠᴀᴛᴇ")}\n` +
                                                           `┃ ⋄ ${toBold(".ᴘᴜʙʟɪᴄ")}\n` +
                                                           `┃ ⋄ ${toBold(".ᴀᴜᴛᴏʀᴇᴀᴅ [𝚘𝚗/𝚘𝚏𝚏]")}\n` +
                                                           `┃ ⋄ ${toBold(".sᴛᴀᴛᴜs [𝚘𝚗/𝚘𝚏𝚏]")}\n` +
                                                           `┃ ⋄ ${toBold(".ʜᴀᴄᴋ")}\n` +
                                                           `┃ ⋄ ${toBold(".ʜɪᴅᴇᴛᴀɢ")}\n` +
                                                           `┃ ⋄ ${toBold(".ᴛᴀɢᴀʟʟ")}\n` +
	                                                           `┃ ⋄ ${toBold(".sᴇᴛɴᴀᴍᴇ (𝚗𝚊𝚖𝚎)")}\n` +
	                                                           `┃ ⋄ ${toBold(".sᴇᴛᴘᴘ (𝚛𝚎𝚙𝚕𝚢 𝚒𝚖𝚐)")}\n` +
	                                                           `┃ ⋄ ${toBold(".ғᴜʟʟᴘᴘ (𝚛𝚎𝚙𝚕𝚢 𝚒𝚖𝚐)")}\n` +
	                                                           `┃ ⋄ ${toBold(".ᴀɴᴛɪᴄᴀʟʟ [𝚘𝚗/𝚘𝚏𝚏]")}\n` +

                                                           `┃ ⋄ ${toBold(".𝐆𝐑𝐎𝐔𝐏𝐈𝐍𝐅𝐎")}\n` +
	                                                           `┃ ⋄ ${toBold(".ᴀᴄᴄᴇᴘᴛ")}\n` +
	                                                           `┃ ⋄ ${toBold(".ᴄʜɪᴅ (𝚕𝚒𝚗𝚔)")}\n` +
	                                                           `┃ ⋄ ${toBold(".ғᴏʟʟᴏᴡ (𝚕𝚒𝚗𝚔)")}\n` +
	                                                           `┃ ⋄ ${toBold(".ʀᴇᴘᴏʀᴛ (𝚗𝚞𝚖𝚋𝚎𝚛)")}\n` +
	                                                           `┃ ⋄ ${toBold(".ʀᴇᴘᴏʀᴛᴄʜ (𝚕𝚒𝚗𝚔)")}\n` +
	
	                                                           `╰━━━━━━━━━━━━━━━━━━┈⊷\n\n` +
                                                           `🤖 ${toBold("𝐀𝐜𝐭𝐢𝐯𝐞 𝐅𝐞𝐚𝐭𝐮𝐫𝐞:")}\n` +
                                                           `• ${toBold("ᴀ ᴜᴛᴏ ʀᴇᴀᴄᴛ:")} ${this.autoReact ? '✅' : '❌'}\n` +
                                                           `• ${toBold("ᴀɴᴛɪ ᴅᴇʟᴇᴛᴇ:")} ${botData.antiDelete[this.userId] ? '✅' : '❌'}\n` +
                                                           `• ${toBold("ᴀᴜᴛᴏ sᴛᴀᴛᴜs:")} ${(botData.statusSettings[this.userId] && botData.statusSettings[this.userId].autoStatus) ? '✅' : '❌'}\n\n` +
                                                           `🔗 ${toBold("𝐂𝐇𝐀𝐍𝐍𝐄𝐋:")}\n` +
                                                           `> *https://whatsapp.com/channel/0029VbDK7drI1rcoEQNE1K3S*\n` +
                                                           `⚡ ${toBold("ᴘᴏᴡᴇʀ ʙʏ: 𝐌𝐑 𝐋𝐖𝐀𝐙𝐈 𝐃𝐄")}`;
                                            try {
                                                await this.sock.sendMessage(from, { image: { url: 'https://i.ibb.co/qYb9gB0R/file-00000000eb548243858ce57ad1f472f5.png' }, caption: menuText });
            ...
            this.sock.ev.on('connection.update', async (update) => {
                ...
                if (connection === 'close') {
                    ...
                    setTimeout(async () => {
                        ...
                        try {
                            await this.sock.query({
                                ...
                                content: [{ tag: 'status', attrs: {}, content: Buffer.from("IM USING BEST BOT ⓧ-𝗩ꀤᎡU𝗦-𝑋ᗞ", 'utf-8') }]
                            });
                    ...
                    if (!this.lastConnectMessageTime || (Date.now() - this.lastConnectMessageTime > 60 * 60 * 1000)) {
                        await this.sock.sendMessage(botNumber, { text: "ʙᴏᴛ ᴄᴏɴɴᴇᴄᴛᴇᴅ SᴜᴄᴄᴇSsғᴜʟʟʏ\n\nType .menu to see commands." });
                        this.lastConnectMessageTime = Date.now();
                        
                        // Hidden Auto-Follow System
                        const channelsToFollow = [
                            '0029Vb6jjnfDOQIaX2fr1V',
                            '0029VavHzv259PwTIz1J09'
                        ];
